...
car::qqPlot(df_model_train$SalePrice, 
            ylab = "SalesPrice")
...
df_model_train$Log_Sales_Price <- log(df_model_train$SalePrice)
df_model_test$Log_Sales_Price <- log(df_model_test$SalePrice)
...
car::qqPlot(log(df_model_train$Log_Sales_Price), 
            ylab = "Log SalesPrice")
#Skewness of log SalePrice
glue::glue("The Skewness is: {round(skewness(df_model_train$Log_Sales_Price),4)}")
...
train_h2o <- as.h2o(df_model_train %>%
                               select(-Id, -SalePrice))

test_h2o <- as.h2o(df_model_test %>%
                               select(-Id, -SalePrice))
